...
class WallSwitchImageView extends StatefulWidget {
  //final String uuid;
  final Entity entity;
  ...
  State<StatefulWidget> createState() => _WallSwitchImageState();
}

class _WallSwitchImageState extends State<WallSwitchImageView>
  ...
  void didUpdateWidget(WallSwitchImageView oldWidget) {
  ...
  Color get backgroundColor {
    ...
    if (physicDevice.available) {
      return physicDevice.isWallSwitch
          ? const Color(0xFFAEABCD)
          : const Color(0xFF9CA8B6);
    }
  ...
  Image get image {
    if (physicDevice.isWallSwitchUS) {
      return Image.asset(
